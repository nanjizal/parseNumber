...
haxe_Exception.prototype = $extend(Error.prototype,{
	...
	,__properties__: {set___exceptionStack:"set___exceptionStack",get___exceptionStack:"get___exceptionStack",get_native:"get_native",get_stack:"get_stack"}
});
...
parseNumber_ParseNumber.toFloat = function(this1) {
	parseNumber_ParseNumber_parseFloat(this1);
};
parseNumber_ParseNumber.toInt = function(this1) {
	parseNumber_ParseNumber_parseInt(this1);
};
parseNumber_ParseNumber.about = function(this1) {
	parseNumber_ParseNumber_parseTest(this1);
};
parseNumber_ParseNumber.fromArray = function(arr) {
	var out = [];
	var _g = [];
	var _g1 = 0;
	var _g2 = arr.length;
	while(_g1 < _g2) {
		var i = _g1++;
		_g.push(parseNumber_ParseNumber._new(arr[i]));
	}
	return _g;
};
...
var parseNumber_ParseTest = function() {
	utest_Test.call(this);
};
parseNumber_ParseTest.__name__ = "parseNumber.ParseTest";
parseNumber_ParseTest.main = function() {
	var runner = new utest_Runner();
	runner.addCase(new parseNumber_ParseTest());
	utest_ui_Report.create(runner);
	runner.run();
};
parseNumber_ParseTest.__super__ = utest_Test;
parseNumber_ParseTest.prototype = $extend(utest_Test.prototype,{
	testParseNumber_1: function() {
		var left;
		try {
			haxe_Log.trace("trimming start and end spaces \" -100.000 \" = " + parseNumber_ParseNumber_parse(" -100.000 "),{ fileName : "src/parseNumber/ParseTest.hx", lineNumber : 11, className : "parseNumber.ParseTest", methodName : "testParseNumber_1"});
			var no = parseNumber_ParseNumber_parse(" -100.000 ");
			left = no == "-100.000";
		} catch( _g ) {
			haxe_NativeStackTrace.saveStack(_g);
		...
		if(hx_doctest_internal_DocTestUtils.deepEquals(left,right)) {
			utest_Assert.pass("src/parseNumber/ParseNumber.hx:41 [OK] ({\ntrace( 'trimming start and end spaces \" -100.000 \" = ' +  parse(' -100.000 '));\nvar no: String = parse(' -100.000 ');\nno == '-100.000'; }) == true",{ lineNumber : 41, fileName : "src/parseNumber/ParseNumber.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		} else {
			utest_Assert.fail("({\ntrace( 'trimming start and end spaces \" -100.000 \" = ' +  parse(' -100.000 '));\nvar no: String = parse(' -100.000 ');\nno == '-100.000'; }) == true --> Left side `$left` does not equal `$right`.",{ lineNumber : 41, fileName : "src/parseNumber/ParseNumber.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		}
		var left;
		try {
		...
		var left;
		try {
			haxe_Log.trace("removal of leading zeros \"  01\" = " + parseNumber_ParseNumber_parse("  01"),{ fileName : "src/parseNumber/ParseTest.hx", lineNumber : 11, className : "parseNumber.ParseTest", methodName : "testParseNumber_1"});
			var no = parseNumber_ParseNumber_parse("  01");
			left = no == "1";
		} catch( _g ) {
			haxe_NativeStackTrace.saveStack(_g);
			var ex = haxe_Exception.caught(_g).unwrap();
		...
		if(hx_doctest_internal_DocTestUtils.deepEquals(left,right)) {
			utest_Assert.pass("src/parseNumber/ParseNumber.hx:55 [OK] ({\ntrace( 'removal of leading zeros \"  01\" = ' + parse('  01'));\nvar no: String = parse('  01');\nno == '1'; }) == true",{ lineNumber : 55, fileName : "src/parseNumber/ParseNumber.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		} else {
			utest_Assert.fail("({\ntrace( 'removal of leading zeros \"  01\" = ' + parse('  01'));\nvar no: String = parse('  01');\nno == '1'; }) == true --> Left side `$left` does not equal `$right`.",{ lineNumber : 55, fileName : "src/parseNumber/ParseNumber.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		}
		var left;
		try {
			haxe_Log.trace("not allowing multiple dots \"1.2.3\" = " + parseNumber_ParseNumber_parse("1.2.3"),{ fileName : "src/parseNumber/ParseTest.hx", lineNumber : 11, className : "parseNumber.ParseTest", methodName : "testParseNumber_1"});
			var no = parseNumber_ParseNumber_parse("1.2.3");
			left = no == "NaN";
		} catch( _g ) {
			haxe_NativeStackTrace.saveStack(_g);
			var ex = haxe_Exception.caught(_g).unwrap();
		...
		if(hx_doctest_internal_DocTestUtils.deepEquals(left,right)) {
			utest_Assert.pass("src/parseNumber/ParseNumber.hx:62 [OK] ({\ntrace( 'not allowing multiple dots \"1.2.3\" = ' + parse('1.2.3'));\nvar no: String = parse('1.2.3');\nno == 'NaN'; }) == true",{ lineNumber : 62, fileName : "src/parseNumber/ParseNumber.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		} else {
			utest_Assert.fail("({\ntrace( 'not allowing multiple dots \"1.2.3\" = ' + parse('1.2.3'));\nvar no: String = parse('1.2.3');\nno == 'NaN'; }) == true --> Left side `$left` does not equal `$right`.",{ lineNumber : 62, fileName : "src/parseNumber/ParseNumber.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		}
		var left;
		try {
		...
		var left;
		try {
			haxe_Log.trace("not allowing negative symbol within number \"800-83b9\" = " + parseNumber_ParseNumber_parse("800-83b9"),{ fileName : "src/parseNumber/ParseTest.hx", lineNumber : 11, className : "parseNumber.ParseTest", methodName : "testParseNumber_1"});
			var no = parseNumber_ParseNumber_parse("800-83b9");
			left = no == "NaN";
		} catch( _g ) {
			haxe_NativeStackTrace.saveStack(_g);
			var ex = haxe_Exception.caught(_g).unwrap();
		...
		if(hx_doctest_internal_DocTestUtils.deepEquals(left,right)) {
			utest_Assert.pass("src/parseNumber/ParseNumber.hx:76 [OK] ({\ntrace( 'not allowing negative symbol within number \"800-83b9\" = ' + parse('800-83b9'));\nvar no: String = parse('800-83b9');\nno == 'NaN'; }) == true",{ lineNumber : 76, fileName : "src/parseNumber/ParseNumber.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		} else {
			utest_Assert.fail("({\ntrace( 'not allowing negative symbol within number \"800-83b9\" = ' + parse('800-83b9'));\nvar no: String = parse('800-83b9');\nno == 'NaN'; }) == true --> Left side `$left` does not equal `$right`.",{ lineNumber : 76, fileName : "src/parseNumber/ParseNumber.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		}
		var left;
		try {
	...
	,__class__: parseNumber_ParseTest
});
...
parseNumber_StringCodeIterator.__name__ = "parseNumber.StringCodeIterator";
parseNumber_StringCodeIterator.prototype = {
	str: null
	,b: null
	,pos: null
	,c: null
	...
	,__class__: parseNumber_StringCodeIterator
};
...
utest_TestResult.prototype = {
	...
	,assertations: null
	,allOk: function() {
		var _g = this.assertations.iterator();
		while(_g.hasNext()) {
			var l = _g.next();
			if(l._hx_index == 0) {
				var _g1 = l.pos;
